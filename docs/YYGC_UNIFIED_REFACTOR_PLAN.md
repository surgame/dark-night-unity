...
本计划已进入实施。**U0／U1 已完成，U2 工人／采集／住宅切片、真实 Play、Mono 三进程与框架回归已通过；U3–U6 继续实施。** 实际证据持续记入[实施记录](YYGC_UNIFIED_IMPLEMENTATION.md)。本计划接续最后一轮架构评估，取代 [C 方案](C_REFACTOR_PLAN.md)作为后续重构方向；C 方案和[场景入口修复](SCENE_DEFINITIONS.md)仍是历史证据。
...
U2 已完成，下一阶段为 U3 全部玩法能力迁移。当前新版只有工人、松林、住宅及基础酒馆，协议 6 和 v2 存档已在切片使用；正式入口切换、旧模型删除及最终完整验收仍待 U3–U6，不把切片通过视为完整游戏迁移完成。
