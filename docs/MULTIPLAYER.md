...
2026-09-12 当前状态：正式玩法经 YYGC 命令／状态链接通，协议 5 已接入主机授权存档、同房间重开、120 秒恢复凭据及真实新快照 Ready。FishNet 断线分片修复后，九组四进程弱网恢复各 22/22、并发 13/13、三夜 17/17 通过；新 Mono 追加活跃施工／训练／箭矢组合恢复 13/13；M5 的画面和普通 Player 性能仍待收口。实现见[正式网络](FORMAL_NETWORK.md)、[恢复接入](NETWORK_RECOVERY.md)。沿用 2–4 人共享营地和 Windows 房主 LAN／直连；公网房间、邀请、中继、平台身份及房主迁移不在首版范围。下文的拆流等内容保留为测量超限后才启用的设计。
