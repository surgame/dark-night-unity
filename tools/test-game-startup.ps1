...
try {
    ...
    $checks['formal_object_content_loaded_once'] = [regex]::Matches($text, 'DARK_NIGHTS_FORMAL_CONTENT_READY definitions=3 commands=2 states=1 behaviours=1 identity=GuidFirst wire=GuidV2').Count -eq 1
