...
2026-09-21 新增实验分支 `codex/cave-8x8-art-direction` 的[洞穴 8×8 岩层风格实验](docs/CAVE_8X8_STYLE.md)：在不改地图、坡形、碰撞、协议 12／存档 v8 的前提下，将洞穴材质收敛为 8 px 原生分面、暖棕灰同色系与固定边缘衰减。洞穴 Editor 8/8 与默认种子实际 Play 截图通过；正式远征同屏、Player／联机和前台性能未在本批重验，不替代下方当前远征交付结论。
